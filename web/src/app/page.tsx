        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-primary-light uppercase tracking-widest font-medium">Projects</span>
            </div>
            <h2 className="section-title">Our Projects</h2>
          </div>
          <Link href="/projects" className="text-sm text-muted hover:text-primary-light flex items-center gap-1.5 transition-colors pb-1">
            View all <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
              ...
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-1.5 mt-3">
                  {project.tags.map((tag) => (
                    <span key={tag} className="text-[10px] font-medium px-2 py-0.5 rounded-md bg-primary/10 text-primary-light border border-primary/20">
                      {tag}
                    </span>
                  ))}
                </div>
